...
class SendingEmailOverlay extends StatefulWidget {
  const SendingEmailOverlay({super.key});

  @override
  State<SendingEmailOverlay> createState() => _SendingEmailOverlayState();
}

class _SendingEmailOverlayState extends State<SendingEmailOverlay>
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    l10n.sendingEmailTitle,
                    textAlign: TextAlign.center,
                    style: AppTextStyles.headlineSm,
                  ),
                  const SizedBox(height: 6),
                  Text(
                    l10n.sendingEmailSubtitle,
                    textAlign: TextAlign.center,
